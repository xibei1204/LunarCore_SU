...
public final class HEGPLGCMFGLOuterClass {
  /**
   * Protobuf type {@code HEGPLGCMFGL}
   */
  public static final class HEGPLGCMFGL extends ProtoMessage<HEGPLGCMFGL> implements Cloneable {
    ...
    /**
     * <code>optional .OONMAJPKFHL JCDFAHJFOCC = 12;</code>
     */
    private final OONMAJPKFHLOuterClass.OONMAJPKFHL jCDFAHJFOCC = OONMAJPKFHLOuterClass.OONMAJPKFHL.newInstance();
    ...
    /**
     * @return a new empty instance of {@code HEGPLGCMFGL}
     */
    public static HEGPLGCMFGL newInstance() {
      return new HEGPLGCMFGL();
    }
     ...
     * @return this
     */
    public HEGPLGCMFGL clearStatus() {
     ...
     * equivalent to {@link HEGPLGCMFGL#getStatus()}.getNumber().
     *
     ...
     * can cause {@link HEGPLGCMFGL#getStatus()} to return null
     *
     * @param value the numeric wire value to set
     * @return this
     */
    public HEGPLGCMFGL setStatusValue(final int value) {
      bitField0_ |= 0x00000001;
      status = value;
      return this;
    }
     ...
     * @return this
     */
    public HEGPLGCMFGL setStatus(final RogueStatusOuterClass.RogueStatus value) {
      bitField0_ |= 0x00000001;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearRogueBuffInfo() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setRogueBuffInfo(final RogueBuffInfoOuterClass.RogueBuffInfo value) {
      bitField0_ |= 0x00000002;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearLIJCHOCOPEK() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setLIJCHOCOPEK(final BELMNIPGEDNOuterClass.BELMNIPGEDN value) {
      bitField0_ |= 0x00000004;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearCKJPPDKJIOH() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setCKJPPDKJIOH(final AKKLFHFHPFNOuterClass.AKKLFHFHPFN value) {
      bitField0_ |= 0x00000008;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearInitialPendingAction() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setInitialPendingAction(
     ...
     * @return this
     */
    public HEGPLGCMFGL clearRogueAvatarInfo() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setRogueAvatarInfo(final RogueAvatarInfoOuterClass.RogueAvatarInfo value) {
      bitField0_ |= 0x00000020;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearRogueMapInfo() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setRogueMapInfo(final RogueMapInfoOuterClass.RogueMapInfo value) {
      bitField0_ |= 0x00000040;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearJCDFAHJFOCC() {
     ...
     * @return internal storage object for reading
     */
    public OONMAJPKFHLOuterClass.OONMAJPKFHL getJCDFAHJFOCC() {
      return jCDFAHJFOCC;
    }
     ...
     * @return internal storage object for modifications
     */
    public OONMAJPKFHLOuterClass.OONMAJPKFHL getMutableJCDFAHJFOCC() {
      bitField0_ |= 0x00000080;
      return jCDFAHJFOCC;
    }
     ...
     * @return this
     */
    public HEGPLGCMFGL setJCDFAHJFOCC(final OONMAJPKFHLOuterClass.OONMAJPKFHL value) {
      bitField0_ |= 0x00000080;
     ...
     * @return this
     */
    public HEGPLGCMFGL clearLBKELDKEMLF() {
     ...
     * @return this
     */
    public HEGPLGCMFGL setLBKELDKEMLF(final LMDFPHAHJGLOuterClass.LMDFPHAHJGL value) {
      bitField0_ |= 0x00000100;
    ...
    @Override
    public HEGPLGCMFGL copyFrom(final HEGPLGCMFGL other) {
    ...
    @Override
    public HEGPLGCMFGL mergeFrom(final HEGPLGCMFGL other) {
      if (other.isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    public boolean equals(Object o) {
      ...
      if (!(o instanceof HEGPLGCMFGL)) {
        return false;
      }
      HEGPLGCMFGL other = (HEGPLGCMFGL) o;
    ...
    public HEGPLGCMFGL mergeFrom(final ProtoSource input) throws IOException {
    ...
    @Override
    public HEGPLGCMFGL mergeFrom(final JsonSource input) throws IOException {
    ...
    @Override
    public HEGPLGCMFGL clone() {
      return new HEGPLGCMFGL().copyFrom(this);
    }
    ...
    public static HEGPLGCMFGL parseFrom(final byte[] data) throws InvalidProtocolBufferException {
      return ProtoMessage.mergeFrom(new HEGPLGCMFGL(), data).checkInitialized();
    }

    public static HEGPLGCMFGL parseFrom(final ProtoSource input) throws IOException {
      return ProtoMessage.mergeFrom(new HEGPLGCMFGL(), input).checkInitialized();
    }

    public static HEGPLGCMFGL parseFrom(final JsonSource input) throws IOException {
      return ProtoMessage.mergeFrom(new HEGPLGCMFGL(), input).checkInitialized();
    }

    /**
     * @return factory for creating HEGPLGCMFGL messages
     */
    public static MessageFactory<HEGPLGCMFGL> getFactory() {
      return HEGPLGCMFGLFactory.INSTANCE;
    }

    private enum HEGPLGCMFGLFactory implements MessageFactory<HEGPLGCMFGL> {
      INSTANCE;

      @Override
      public HEGPLGCMFGL create() {
        return HEGPLGCMFGL.newInstance();
      }
    }
