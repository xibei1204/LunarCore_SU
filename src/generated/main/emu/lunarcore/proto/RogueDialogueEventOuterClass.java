...
public final class RogueDialogueEventOuterClass {
  ...
  public static final class RogueDialogueEvent extends ProtoMessage<RogueDialogueEvent> implements Cloneable {
    ...
    /**
     * <code>optional uint32 HDIJKIFPHLP = 1;</code>
     */
    private int hDIJKIFPHLP;
    ...
    /**
     * <code>optional uint32 HDIJKIFPHLP = 1;</code>
     * @return whether the hDIJKIFPHLP field is set
     */
    public boolean hasHDIJKIFPHLP() {
     ...
     * @return this
     */
    public RogueDialogueEvent clearHDIJKIFPHLP() {
    ...
    /**
     * <code>optional uint32 HDIJKIFPHLP = 1;</code>
     * @return the hDIJKIFPHLP
     */
    public int getHDIJKIFPHLP() {
      return hDIJKIFPHLP;
    }

    /**
     * <code>optional uint32 HDIJKIFPHLP = 1;</code>
     * @param value the hDIJKIFPHLP to set
     * @return this
     */
    public RogueDialogueEvent setHDIJKIFPHLP(final int value) {
      bitField0_ |= 0x00000001;
      hDIJKIFPHLP = value;
      return this;
    }
    ...
    public RogueDialogueEvent mergeFrom(final RogueDialogueEvent other) {
      ...
      cachedSize = -1;
      if (other.hasHDIJKIFPHLP()) {
        setHDIJKIFPHLP(other.hDIJKIFPHLP);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        && (!hasHDIJKIFPHLP() || hDIJKIFPHLP == other.hDIJKIFPHLP)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      if ((bitField0_ & 0x00000001) != 0) {
        ...
        output.writeUInt32NoTag(hDIJKIFPHLP);
      }
    ...
    protected int computeSerializedSize() {
      int size = 0;
      if ((bitField0_ & 0x00000001) != 0) {
        size += 1 + ProtoSink.computeUInt32SizeNoTag(hDIJKIFPHLP);
      }
      if ((bitField0_ & 0x00000002) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      output.beginObject();
      if ((bitField0_ & 0x00000001) != 0) {
        output.writeUInt32(FieldNames.hDIJKIFPHLP, hDIJKIFPHLP);
      }
      if ((bitField0_ & 0x00000002) != 0) {
    ...
    public RogueDialogueEvent mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          case 309589607: {
            if (input.isAtField(FieldNames.hDIJKIFPHLP)) {
    ...
    static class FieldNames {
      static final FieldName hDIJKIFPHLP = FieldName.forField("HDIJKIFPHLP");
