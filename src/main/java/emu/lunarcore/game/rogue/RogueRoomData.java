...
import emu.lunarcore.proto.RogueRoomInfoOuterClass;
...
public class RogueRoomData {
    ...
    public RogueRoomInfoOuterClass.RogueRoomInfo toRoomInfoProto() {
        var proto = RogueRoomInfoOuterClass.RogueRoomInfo.newInstance()
            .setRoomId(this.getRoomId())
            .setSiteId(this.getSiteId())
            .setRoomStatusValue(this.getStatus());
